...
\begin{align}
    V_{\theta}(s) &= \E_{\theta} \left[ G_0 | S_{0} = s \right] =
...
\begin{align}
    Q_{\theta}(s,a) &= \E_{\theta} \left[ G_0 | S_0 = s, A_{0} = a \right] = 
    \E_{\theta}\left[\sum_{k=0}^{\infty} \discountFactor^{k} R_{k+1} | 
        S_0 = s, A_{0} = a \right].
...
\begin{align}
    A_{\theta}(s,a) &= V_{\theta}(s,a) - Q_{\theta}(s,a).
...
\begin{align*}
    ...
    \E_{\theta} \left[ \sum_{i=0}^{\infty} 
    \nabla_{\theta}\log\policy_{\theta}(A_i | S_i) G_{0} \right].
\end{align*}
...
\begin{align*}
    \nabla_{\theta} J(\theta) &= 
    \E_{\theta} \left[ \sum_{i=0}^{\infty} 
    \nabla_{\theta}\log\policy_{\theta}(A_i | S_i) G_{i} \right].
\end{align*}
