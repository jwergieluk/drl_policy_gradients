...
there is an end of the task, i.e.\ some notion of ``begin done''.
...
\footnote{In the literature, people use the adjective ``continuous''.
    ...
    The work ``perpetual'' is much better at conveying the property 
    of running indefinitely long. See e.g.\ \href{https://www.youtube.com/watch?v=t5TK1OxEj9A}{``Testament of the 
    doomslayer''}.
} 
...
\end{align*}
$\policyLik(.|s)$ is the probability function of the probability measure $\policy(.|s)$.
