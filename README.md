# The Reacher environment solved using Deep Deterministic Policy Gradient (DDPG) algorithm
...
We train a DDPG agent in an environment containing 20 copies of the problem. The environment 
...
The above command runs 250 training episodes and saves the results to the current directory.
